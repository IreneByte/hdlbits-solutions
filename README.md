...
- **Thinking in hardware** — unlearning sequential/imperative habits and getting comfortable with concurrent logic, `assign` statements, and `always` blocks
